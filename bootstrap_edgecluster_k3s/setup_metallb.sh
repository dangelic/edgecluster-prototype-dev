...
# --- Reference
# File: https://github.com/rgl/k3s-vagrant/blob/master/provision-metallb.sh
# GitHub commit: #04036e9
# Date: 11.01.2023 in DD/MM/YYYY - 23:11:00 MEZ
# Author: Rui Lopes (GitHub Account: rgl: https://github.com/rgl)
# Modifications by the owner of this repository (dangelic):
# - Adjusting vars for Metallb chart version and IP range

#------------------------------------------------------------------------

set -euo pipefail

METALLB_CHART_VERSION="$1"; shift
LB_IP_RANGE="$1"; shift
